...
- `最近5小时`、`3小时前`、`今天14:00-18:00`、`今天23点到次日2点` 这类 hour-grain 短语必须保持为单个 unit，不能把小时端点拆散。
...
- `sources[].source_unit_id` 只能引用本次输出里已经出现过的真实 unit_id，绝不能捏造 `anchor_current_year`、`system_datetime_anchor` 之类 synthetic anchor。
...
_FEW_SHOTS: list[tuple[dict[str, Any], dict[str, Any]]] = [
    (
        {"query": "2025年3月的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "2025年3月的收益",
    ...
    (
        {"query": "2025年3月和5月的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "2025年3月和5月的收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "今年3月和5月，去年同期", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "今年3月和5月，去年同期",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "去年同期员工数有多少", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "去年同期员工数有多少",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年Q1收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "2025年Q1收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年每个季度收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "2025年每个季度收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年9月到12月的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "去年12月到3月的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "去年12月到3月的收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年9月到12月的各月份收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "2025年9月和12月的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "最近7天收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近7天收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "最近一个月收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近一个月收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "最近1个补班日收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近1个补班日收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年3月对比2024年3月", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "最近5个工作日的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近5个工作日的收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "最近5天中的工作日收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近5天中的工作日收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年每天收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "2025年每天收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "最近半年每季度收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近半年每季度收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "最近一年每半年收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "最近一年每半年收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
    ...
    (
        {"query": "2025年3月的工作日对比2024年3月的工作日", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "2025年中秋假期和国庆假期收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "2025年和2024年3月收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
    ...
    (
        {"query": "今天14:00-18:00的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "今天14:00-18:00的收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
            "units": [
                {
                    "unit_id": "u1",
                    "render_text": "今天14:00-18:00",
                    "surface_fragments": [{"start": 0, "end": 13}],
                    "content_kind": "standalone",
                    "self_contained_text": "今天14:00-18:00",
                    "sources": [],
                }
            ],
            "comparisons": [],
    ...
    (
        {"query": "今天23点到次日2点的收益", "system_datetime": "2026-04-17T00:00:00", "timezone": "Asia/Shanghai"},
        {
            "query": "今天23点到次日2点的收益",
            "system_datetime": "2026-04-17T00:00:00",
            "timezone": "Asia/Shanghai",
            "units": [
                {
                    "unit_id": "u1",
                    "render_text": "今天23点到次日2点",
                    "surface_fragments": [{"start": 0, "end": 10}],
                    "content_kind": "standalone",
                    "self_contained_text": "今天23点到次日2点",
                    "sources": [],
                }
            ],
            "comparisons": [],
