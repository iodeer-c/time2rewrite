...
def test_process_query_can_render_previous_month_annotation_without_llm_config():
    service = QueryPipelineService(
        planner=FakePlanner(
            {
                "nodes": [
...
def test_process_query_can_render_previous_year_annotation_without_llm_config():
    service = QueryPipelineService(
        planner=FakePlanner(
            {
                "nodes": [
    ...
    assert response["rewritten_query"] == "去年（2025年1月1日至2025年12月31日）的收益是多少？"


def test_process_query_can_render_quarter_to_date_annotation_without_llm_config():
    service = QueryPipelineService(
        planner=FakePlanner(
            {
                "nodes": [
    ...
    assert response["rewritten_query"] == "本季度至今（2026年4月1日至2026年4月15日）的收益是多少？"


def test_process_query_can_render_year_to_date_annotation_without_llm_config():
    service = QueryPipelineService(
        planner=FakePlanner(
            {
                "nodes": [
    ...
    assert response["rewritten_query"] == "本年至今（2026年1月1日至2026年4月15日）的收益是多少？"


def test_process_query_can_render_regular_grain_window_annotation_without_llm_config():
    service = QueryPipelineService(
        planner=FakePlanner(
            {
                "nodes": [
    ...
    assert response["rewritten_query"] == "本月至今每天（2026年4月1日至2026年4月15日）的收益是多少？"
